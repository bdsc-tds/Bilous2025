...
# ── USER CONFIG ───────────────────────────────────────────────────────────────
MTX_DIR <- "/path/to/breast_mtx"     # output directory from 03_breast_h5ad_to_mtx.py
OUT_RDS <- "/path/to/breast.rds"
# ─────────────────────────────────────────────────────────────────────────────
...
seu@meta.data <- seu@meta.data %>%
  mutate(Level2 = recode(Level3,
    ...
    DC_2                 = "dendritic cell",
    Fibroblast           = "fibroblast of breast",
    Fibroblast_1GVR      = "fibroblast of breast",
