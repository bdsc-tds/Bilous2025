                ...
                for reference in references:
                    for method in methods:
                        for level in levels:
                            ...
                            out_file = figures_dir / f"scib_metrics_panel_plot/{name}/scib_metrics_{layer}_{reference}_{method}_{level}_{n_comps=}_{max_n_cells=}.{extension}"
                            out_files_panel.append(out_file)

                            rule:
                                name: f'scib_metrics_panel_plot/{name}/scib_metrics_{layer}_{reference}_{method}_{level}'
                                input:
                                    scib_metrics_is_done=results_dir / "scib_metrics.done",
                                    scib_metrics_corrected_couts_is_done=results_dir / "scib_metrics_corrected_counts.done",
                                output:
                                    out_file=out_file,
                                params:
