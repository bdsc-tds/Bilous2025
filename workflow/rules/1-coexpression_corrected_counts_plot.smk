    ...
    for panel in (panels := condition.iterdir()):
        for method in methods:
            for target_count in target_counts:
                ...
                panel_coexpression_corrected_counts = results_dir / f'coexpression_corrected_counts/{name}'
                out_file_plot_sample = figures_dir / f'coexpression_corrected_counts_plot_panel/{name}/coexpression_{method}_{target_count=}_{min_cond_coex_str}_sample.{extension}'
                out_file_plot_panel = figures_dir / f'coexpression_corrected_counts_plot_panel/{name}/coexpression_{method}_{target_count=}_{min_cond_coex_str}_panel.{extension}'
                out_file_gene_pairs = results_dir / f'coexpression_corrected_counts_gene_pairs/{name}/coexpression_gene_pairs_{method}_{target_count=}_{min_cond_coex_str}.parquet'
                ...
                rule:
                    name: f'coexpression_corrected_counts_plot_panel/{name}/coexpression_{method}_{target_count=}'
                    input:
                        coexpression_corrected_counts_is_done=results_dir / "coexpression_corrected_counts.done",
                    output:
                    ...
                    shell:
                        ...
                        python workflow/scripts/xenium/coexpression_corrected_counts_panel_plot.py \
                        --coexpression_corrected_counts_dir {params.coexpression_corrected_counts_dir} \
...
for method in methods:
    for target_count in target_counts:
        ...
        out_file_plot = figures_dir / f'coexpression_corrected_counts_plot_conditions/coexpression_{method}_{target_count=}_{min_cond_coex_str}_conditions.{extension}'
        out_file_gene_pairs = results_dir / f'coexpression_corrected_counts_conditions_gene_pairs/coexpression_gene_pairs_{method}_{target_count=}_{min_cond_coex_str}.parquet'
        ...
        rule:
            name: f'coexpression_corrected_counts_plot_conditions/coexpression_{method}_{target_count=}'
            input:
                coexpression_corrected_counts_is_done=results_dir / "coexpression_corrected_counts.done",
            output:
