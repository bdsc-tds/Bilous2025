params_product = list(product(normalisations, layers, references, methods, levels, train_modes))
                ...
                for panel in (panels := condition.iterdir()):
                    ...
                    for donor in (donors := panel.iterdir()):
                        for sample in (samples := donor.iterdir()):
                            for normalisation, layer, reference, method, level, train_mode in params_product:
