                                ...
                                for reference in references:
                                    for method in methods:
                                        for level in levels:
                                            ...
                                            out_file_df_permutations_logreg = results_dir / f'contamination_metrics_{name_params}_logreg/{name}/{normalisation}/{layer}_{reference}_{method}_{level}_permutations_logreg.parquet'
                                            out_file_df_importances_logreg = results_dir / f'contamination_metrics_{name_params}_logreg/{name}/{normalisation}/{layer}_{reference}_{method}_{level}_importances_logreg.parquet'
                                            out_file_df_markers_rank_significance_logreg = results_dir / f'contamination_metrics_{name_params}_logreg/{name}/{normalisation}/{layer}_{reference}_{method}_{level}_markers_rank_significance_logreg.json'
                                            ...
                                            rule:
                                                name: f'contamination_metrics_{name_params}_logreg/{name}/{normalisation}/{layer}_{reference}_{method}_{level}'
                                                input:
