...
if proseg_format:
    ...
    coordinate_df = coordinate_df[~coordinate_df["gene"].str.contains("|".join(["BLANK_", "Codeword", "NegControl"]))]
...
coordinate_df[["x_pixel", "y_pixel", "n_pixel", "z_delim"]].to_parquet(out_file_transcript_info)
