...
RELATIVE_PATHS=(
  ...
  "resolvi_embed_panel/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.png"
  "resolvi_supervised_embed_panel/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.png"
  ...
  "resolvi_embed_panel/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.png"
  "resolvi_supervised_embed_panel/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.png"
  ...
  "scib_metrics_panel_plot/breast/breast/lognorm/scib_metrics_iLISI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.png"

  # contamination logreg boxplots
  "contamination_metrics_diffexpr_radius=15_n_permutations=30_n_splits=5_top_n=20_precision_spatial_specificity_logreg_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_importances_n_hits_top_n=20.png"

  # contamination diffexpr boxplots
  "contamination_metrics_diffexpr_radius=15_top_n=20_specificity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_logfoldchanges_n_hits_top_n=20.png"

  # summary stats
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_median_n_genes.png"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_n_cells.png"
  "contamination_metrics_cosine_similarity_scrnaseq_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_cosine_similarity.png"

  # gsea heatmaps
  "heatmap_diffexpr_gsea/heatmap_ref_panel='breast'_ref_segmentation='5µm'.png"
  "heatmap_diffexpr_gsea/heatmap_ref_panel='breast'_ref_segmentation='ProSeg'.png"
