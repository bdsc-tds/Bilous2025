...
RELATIVE_PATHS=(
  ...
  "embed_panel_restricted_genes_scrnaseq/Xenium_hLung_v1_metadata/matched_lung_standard/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.png"
